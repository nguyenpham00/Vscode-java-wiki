...
The m2e team has decided to require Java 17 as the minimum requirement for its September 2022 release. See https://github.com/eclipse-m2e/m2e-core/pull/740. We use m2e core components to provide Maven support for the Java language server ([Eclipse JDT.LS](https://github.com/eclipse/eclipse.jdt.ls)). This requires the entire language server to run on a minimum of Java 17.
